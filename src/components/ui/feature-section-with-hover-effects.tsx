    ...
    <section className="bg-secondary py-20 lg:py-28">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        ...
        <div className="text-center mb-16">
          <span className="inline-flex items-center rounded-full bg-purple-100 dark:bg-purple-900/50 px-4 py-1.5 text-sm font-semibold text-purple-700 dark:text-purple-300 mb-4">
            The Problem
          </span>
  ...
  return (
    <div
      className={cn(
        ...
        (index === 0 || index === 3) && "lg:border-l border-secondary",
        index < 3 && "lg:border-b border-secondary"
      )}
    >
      {index < 3 && (
        <div className="opacity-0 group-hover/feature:opacity-100 transition duration-200 absolute inset-0 h-full w-full bg-gradient-to-t from-purple-100/50 dark:from-purple-900/20 to-transparent pointer-events-none" />
      )}
      {index >= 3 && (
        <div className="opacity-0 group-hover/feature:opacity-100 transition duration-200 absolute inset-0 h-full w-full bg-gradient-to-b from-purple-100/50 dark:from-purple-900/20 to-transparent pointer-events-none" />
      )}
      ...
      <div className="text-3xl md:text-4xl font-bold mb-2 relative z-10 px-10 text-primary">
        {stat}
      </div>
      <div className="text-lg font-bold mb-2 relative z-10 px-10">
        <div className="absolute left-0 inset-y-0 h-6 group-hover/feature:h-8 w-1 rounded-tr-full rounded-br-full bg-gray-300 dark:bg-gray-600 group-hover/feature:bg-purple-600 transition-all duration-200 origin-center" />
        <span className="group-hover/feature:translate-x-2 transition duration-200 inline-block text-primary">
          {title}
        </span>
      </div>
      <p className="text-sm text-tertiary max-w-xs relative z-10 px-10">
        {description}
      </p>
    </div>
  );
