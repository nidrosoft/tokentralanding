      ...
      <div className="mx-auto w-full max-w-container px-4 md:px-8">
        ...
        >
          ...
          >
            ...
            >
              <TabsList className="flex w-full h-12 cursor-pointer bg-secondary">
                <TabsTrigger value="monthly" className="text-base font-medium cursor-pointer flex-1 px-6">Monthly</TabsTrigger>
                <TabsTrigger value="yearly" className="text-base font-medium flex items-center gap-2 cursor-pointer flex-1 px-6">
                  Yearly
